...
exports.router.post("/getUser", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    // fetch user from token
    const user = (_a = loginApi.fetchLoginToken(req.cookies["LoginToken"])) === null || _a === void 0 ? void 0 : _a.data;
    if (!user) {
